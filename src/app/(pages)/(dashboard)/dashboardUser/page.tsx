...
async function DashboardUser() {
  ...
  return (
    <div className="w-full h-max">
      <main className="px-10 py-7 w-full h-[200vh] flex flex-col items-center bg-gray-50">
        ...
        <article className="w-full h-max flex flex-col items-center mx-8 border-b-2 border-solid border-black">
          ...
          <div className="flex flex-col items-center absolute bg-white shadow-md rounded-md mt-32 pt-24 pb-7 px-8 w-4/5">
            ...
            <div className="w-full h-max flex flex-col items-start mt-5 gap-6">
              ...
              <div>
                ...
                <p className="text-lg bg-gray-200 px-6 capitalize">Surabaya</p>
              </div>
              <div>
